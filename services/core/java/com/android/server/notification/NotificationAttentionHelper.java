...
public final class NotificationAttentionHelper {
    ...
    private void registerBroadcastListeners() {
        ...
        mContext.getContentResolver().registerContentObserver(
                ...
                UserHandle.USER_ALL);
        mContext.getContentResolver().registerContentObserver(
                SettingsObserver.NOTIFICATION_SOUND_VIB_SCREEN_ON, false, mSettingsObserver,
                UserHandle.USER_ALL);
        if (Flags.politeNotifications()) {
            mContext.getContentResolver().registerContentObserver(
    ...
    private final class SettingsObserver extends ContentObserver {
        ...
        private static final Uri NOTIFICATION_SOUND_VIB_SCREEN_ON =
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (NOTIFICATION_SOUND_VIB_SCREEN_ON.equals(uri)) {
