...
/** Control the color transform for global color temperature. */
final class DisplayColorTemperatureTintController extends TintController {

    private static final String TAG = "DisplayColorTemperatureController";

    // All values are in Kelvin
    static final int DEFAULT_TEMPERATURE = 6500;
    static final int MIN_TEMPERATURE = 3000;
    static final int MAX_TEMPERATURE = 9000;
    ...
    public void setMatrix(int value) {
        final int temperature = MathUtils.constrain(value, MIN_TEMPERATURE, MAX_TEMPERATURE);
        final float[] rgb = temperatureToRGB(temperature);

        Slog.d(TAG, "Set color temperature: " + temperature + "K, RGB: " + Arrays.toString(rgb));
    ...
    @Override
    public int getLevel() {
        return DisplayTransformManager.LEVEL_COLOR_MATRIX_COLOR_TEMPERATURE;
    }
    ...
    // Below code is courtesy of LineageOS SDK,
    // authored by Steve Kondik <steve@cyngn.com>.
